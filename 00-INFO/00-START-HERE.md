...
You do **not** need to understand every Python file before using it. Start here, follow the three-step quick path, then use the map when you need more detail.
